...
import com.swan.twoafterfour.dialog.SelectColorDialog;
import com.swan.twoafterfour.task.eventset.AddEventSetTask;
...
public class AddEventSetActivity extends BaseActivity implements View.OnClickListener,
		OnTaskFinishedListener<EventSet>, SelectColorDialog.OnSelectColorListener {
	...
	private void addEventSet() {
		...
		if (TextUtils.isEmpty(name)) {
			...
			new AddEventSetTask(this, this, eventSet).executeOnExecutor(AsyncTask
