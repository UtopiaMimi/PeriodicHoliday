...
public class SelectEventSetAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_select_event_set,
					parent, false);
		...
		holder.ivEventSetIcon.setImageResource(eventSet.getId() == 0 ? R.mipmap
				.ic_select_event_set_category : R.mipmap.ic_select_event_set_icon);
