package com.swan.twoafterfour.task.eventset;
...
public class AddEventSetTask extends BaseAsyncTask<EventSet> {
	...
	public AddEventSetTask(Context context, OnTaskFinishedListener<EventSet>
			onTaskFinishedListener, EventSet eventSet) {
