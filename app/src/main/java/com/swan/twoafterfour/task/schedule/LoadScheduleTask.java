package com.swan.twoafterfour.task.schedule;
...
public class LoadScheduleTask extends BaseAsyncTask<List<Schedule>> {
	...
	public LoadScheduleTask(Context context, OnTaskFinishedListener<List<Schedule>>
			onTaskFinishedListener, int year, int month, int day) {
